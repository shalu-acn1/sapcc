...
export default {
  ...
  assets: {
    'index.csr.html': {size: 27039, hash: 'e9c10973c4c33e2a64855331fa3d8a131fc6d76411736292375e4ddc51383be5', text: () => import('./assets-chunks/index_csr_html.mjs').then(m => m.default)},
    'index.server.html': {size: 1637, hash: 'cd74e3e00abea416dc94bf2c96e9dc79c7a35280233e15e735d89ae7a6c4a85f', text: () => import('./assets-chunks/index_server_html.mjs').then(m => m.default)},
    'styles-Z2UGE7W2.css': {size: 925920, hash: 'g2/tJB2iiyw', text: () => import('./assets-chunks/styles-Z2UGE7W2_css.mjs').then(m => m.default)}
  },
};
